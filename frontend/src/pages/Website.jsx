...
const Website = () => {
  ...
  // replace existing initial chat with bot intro
const [chatMessages, setChatMessages] = useState([
  { id: 1, text: "Hi! I’m EVA (Event Volunteer Assistant). Type 'menu' to see options.", sender: "bot" }
]);
  ...
  const handleChatSubmit = (e) => {
    ...
    if (message.trim()) {
      ...
      setTimeout(() => {
        ...
        setChatMessages(prev => [...prev, { id: Date.now(), text: response, sender: "support" }]);
      }, 1000);
    }
  };
          ...
          <div className="success-grid">
            <div className="success-card animate-zoom">
              <div className="success-image-container">
                <img src="/images/story1.png" alt="Community Clean-Up Drive" />
      ...
      <section className="timeline-section">
        <div className="container">
          ...
          <div className="timeline-cta">
            <Link to="/event" className="btn-register">View All Events</Link>
          </div>
        </div>
      </section>
